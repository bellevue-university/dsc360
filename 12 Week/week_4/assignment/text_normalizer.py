...
# These next four lines of code ensure your reusable code can
# be found by Python. This can also be set using IDE settings if you
# prefer
import sys
from os.path import dirname
root_dir = 'C:\\Users\\neugg\\OneDrive\\Documents\\GitHub\\text-analytics-python-neuggs\\'
if root_dir not in sys.path:
    sys.path.append(dirname(root_dir))
from week_4.c_contractions import CONTRACTION_MAP
